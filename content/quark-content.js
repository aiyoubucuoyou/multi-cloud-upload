...
(function() {
  ...
  async function performUpload(fileId, taskId, service) {
    ...
    try {
      ...
      console.log('夸克网盘：开始读取分片', meta.chunks, '个');
      ...
      const fileInput = document.querySelector('#ListHeader-file') || 
                        document.querySelector('input[type="file"]');
      
      if (fileInput) {
        console.log('夸克网盘：找到file input，设置文件');
        ...
        console.log('夸克网盘：上传完成');
      } else {
        console.error('夸克网盘：未找到file input');
        chrome.runtime.sendMessage({
          action: 'updateProgress',
          taskId: taskId,
          service: service,
