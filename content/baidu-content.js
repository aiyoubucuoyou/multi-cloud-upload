...
(function() {
  ...
  async function performUpload(fileId, taskId, service) {
    ...
    try {
      ...
      console.log('百度网盘：开始读取分片', meta.chunks, '个');
      ...
      if (fileInput) {
        console.log('百度网盘：找到file input，设置文件');
        ...
        console.log('百度网盘：上传完成');
      } else {
        console.error('百度网盘：未找到file input');
        chrome.runtime.sendMessage({
          action: 'updateProgress',
          taskId: taskId,
          service: service,
